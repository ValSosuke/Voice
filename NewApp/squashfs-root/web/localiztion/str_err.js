...
str_err[ERR_3G_LCP_MRU]							=	"MTU is out of range (576 - 1492). Please input another number.";
...
str_err[ERR_RESERVED_PORTS]						=	"Reserved ports, please input another one.";
...
str_err[ERR_VS_PORT_OCCUPIED]					=	"Error: The ports of the remote web management and the virtual server are conflicted.";
...
str_err[ERR_TDDP_UPLOAD_PRODUCT_INFO_ERR]		= 	"The upload product version is error!";
